...
t.prototype.updateDots=function(){var e=this;null!==e.$dots&&(e.$dots.find("li").removeClass("slick-active").attr("aria-hidden","true"),e.$dots.find("li").eq(Math.floor(e.currentSlide/e.options.slidesToScroll)).addClass("slick-active").attr("aria-hidden","false"))},t.prototype.visibility=function(){var e=this;e.options.autoplay&&(document[e.hidden]?e.interrupted=!0:e.interrupted=!1)},e.fn.slick=function(){var e,n,i=this,o=arguments[0],r=Array.prototype.slice.call(arguments,1),s=i.length;for(e=0;s>e;e++)if("object"==typeof o||"undefined"==typeof o?i[e].slick=new t(i[e],o):n=i[e].slick[o].apply(i[e].slick,r),"undefined"!=typeof n)return n;return i}}),function(e){var t=0;e.fn.scrolled=function(n,i){"function"==typeof n&&(i=n,n=50);var o="scrollTimer"+t++;this.scroll(function(){var t=e(this),r=t.data(o);r&&clearTimeout(r),r=setTimeout(function(){t.removeData(o),i.call(t[0])},n),t.data(o,r)})}}(jQuery),function(e){var t=0;e.fn.resized=function(n,i){"function"==typeof n&&(i=n,n=100);var o="scrollTimer"+t++;this.resize(function(){var t=e(this),r=t.data(o);r&&clearTimeout(r),r=setTimeout(function(){t.removeData(o),i.call(t[0])},n),t.data(o,r)})}}(jQuery),$(document).ready(function(){function e(e){"first"==e?$(".app").css("max-height",$("#firstPage").height()):$(".app").css("max-height",$("#secondPage").height()+$("#firstPage").height())}function t(){var e=0-$("#firstPage").height();$(".app").css("transform","translate3d(0,-"+$("#firstPage").height()+"px,0)").css("margin-bottom",e),n=!0}$('[href="#"]').click(function(e){e.preventDefault()}),$('a[href^="#section"]').click(function(){var e=$(this).attr("href");return $("body, html").animate({scrollTop:$(e).offset().top},1e3),!1}),$('a[href^="#modalForm"]').click(function(){$(".fixed-container").fadeIn(),$(".hero, .content, .footer").addClass("blur"),$("body, html").animate({scrollTop:$(".form--fixed").offset().top-30},1e3),$(".fixed-btn").removeClass("visible")}),$("#closeModal").on("click",function(){$(".fixed-container").fadeOut(),$(".hero, .content, .footer").removeClass("blur"),$(".fixed-btn").addClass("visible")}),$("#owlTestimonials").slick({dots:!0,infinite:!0,speed:300,arrows:!1});var n=!1;setTimeout(function(){e("first")},1e3),$(window).resized(function(){n?(e("sec"),t()):e("first")}),$(window).scrolled(100,function(){n?(console.log("recalc"),e("sec"),t()):e("first")});var i="";$("#ctaFromFirst").on("submit",function(n){return n.preventDefault(),""!=i?($(".ui-select").removeClass("ui-select--error"),setTimeout(function(){e("second")},300),setTimeout(function(){t()},300),$(".fixed-btn").addClass("visible"),$("#pasteSelected").text(i),!1):($(".ui-select").addClass("ui-select--error"),!1)}),$("#ctaFromSecond").on("submit",function(e){var t=$("#ctaFromSecond"),n=t.find("input[type=text]").val(),o=t.find("input[type=tel]").val(),r=t.find("input[type=email]").val(),s=t.find("input[type=checkbox]:checked").val();console.log(s);var a=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,l=!1,c=!0;if(a.test(r)?(l=!0,c=!1):(l=!1,c=!0),"yes"!=s?(console.log("not agreed"),t.find("input[type=checkbox]").parent().addClass("ui-radio--error")):t.find("input[type=checkbox]").parent().removeClass("ui-radio--error"),c?t.find("input[type=email]").parent().addClass("ui-input--error"):t.find("input[type=email]").parent().removeClass("ui-input--error"),""==n||n.length<=3?t.find("input[type=text]").parent().addClass("ui-input--error"):t.find("input[type=text]").parent().removeClass("ui-input--error"),""==o||o.length<=10?t.find("input[type=tel]").parent().addClass("ui-input--error"):t.find("input[type=tel]").parent().removeClass("ui-input--error"),""==s||c||""==n||n.length<=3||""==o||o.length<=10)return!1;var d={name:n,email:r,phone:o,select:i};$.ajax({type:"POST",url:"php/contact.php",data:d,dataType:"json",encode:!0}).done(function(e){alert(e),e.success&&(t.find(".form__wrapper").fadeOut(),t.find(".form__thanks").fadeIn())}).fail(function(e){t.find(".form__wrapper").fadeOut(),t.find(".form__thanks").fadeIn(),setTimeout(function(){t.find(".form__thanks").html("<span>Thank you!</span> <br> We got your contact")},1e3),console.log(e)}),e.preventDefault()}),$(".ui-select").on("click",function(e){$(this).toggleClass("active")}),$(".ui-select__drop span").on("click",function(e){var t=$(this).data("select");$(this).closest(".ui-select").find("label").text(t),$(this).closest(".ui-select").find("label").addClass("selected"),$(".ui-select").removeClass("ui-select--error"),i=t}),$(".ui-input label").on("click",function(){$(this).parent().find("input").trigger("focus")}),$(".ui-input input").each(function(){$(this).on("focus",function(){$(this).parent(".ui-input").addClass("active")}),$(this).on("blur",function(){0==$(this).val().length&&$(this).parent(".ui-input").removeClass("active")}),""!=$(this).val()&&$(this).parent(".ui-input").addClass("active")}),$(window).scrolled(10,function(){var e=$(this).scrollTop()+50,t=$(window).width();t>900?e+$(window).height()<$(document).height()-100&&$(".form--fixed").css("transform","translate3d(0,"+e+"px,0)"):$(".form--fixed").css("transform","translate3d(0,0px,0)")})});