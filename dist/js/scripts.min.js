...
t.prototype.updateDots=function(){var e=this;null!==e.$dots&&(e.$dots.find("li").removeClass("slick-active").attr("aria-hidden","true"),e.$dots.find("li").eq(Math.floor(e.currentSlide/e.options.slidesToScroll)).addClass("slick-active").attr("aria-hidden","false"))},t.prototype.visibility=function(){var e=this;e.options.autoplay&&(document[e.hidden]?e.interrupted=!0:e.interrupted=!1)},e.fn.slick=function(){var e,n,i=this,o=arguments[0],r=Array.prototype.slice.call(arguments,1),s=i.length;for(e=0;s>e;e++)if("object"==typeof o||"undefined"==typeof o?i[e].slick=new t(i[e],o):n=i[e].slick[o].apply(i[e].slick,r),"undefined"!=typeof n)return n;return i}}),function(e){var t=0;e.fn.scrolled=function(n,i){"function"==typeof n&&(i=n,n=50);var o="scrollTimer"+t++;this.scroll(function(){var t=e(this),r=t.data(o);r&&clearTimeout(r),r=setTimeout(function(){t.removeData(o),i.call(t[0])},n),t.data(o,r)})}}(jQuery),$(document).ready(function(){$('[href="#"]').click(function(e){e.preventDefault()}),$('a[href^="#section"]').click(function(){var e=$(this).attr("href");return $("body, html").animate({scrollTop:$(e).offset().top},1e3),!1}),$('a[href^="#modalForm"]').click(function(){$(".fixed-container").removeClass("hiden-mobile").fadeIn(),$(".hero, .content, .footer").addClass("blur"),$("body, html").animate({scrollTop:$(".form--fixed").offset().top-30},1e3),$(".fixed-btn").removeClass("visible")}),$("#closeModal").on("click",function(){$(".fixed-container").addClass("hiden-mobile").fadeOut(),$(".hero, .content, .footer").removeClass("blur"),$(".fixed-btn").addClass("visible")}),$(document).mouseup(function(t){var n=new Array;n.push($(".form--fixed")),$.each(n,function(n,i){$(i).is(t.target)||0!==$(i).has(t.target).length||e&&$(window).width()<900&&($(".fixed-container").addClass("hiden-mobile").fadeOut(),$(".hero, .content, .footer").removeClass("blur"),$(".fixed-btn").addClass("visible"))})}),$("#owlTestimonials").slick({dots:!0,infinite:!0,speed:300,arrows:!1,autoplay:!0,autoplaySpeed:5e3}),$(".app").slick({accessibility:!1,draggable:!1,swipe:!1,touchMove:!1,dots:!1,infinite:!1,speed:300,arrows:!1,adaptiveHeight:!0});var e=!1,t="";$("#ctaFromFirst").on("submit",function(n){return n.preventDefault(),""!=t?($(".ui-select").removeClass("ui-select--error"),$(".app").slick("slickNext"),$("body, html").animate({scrollTop:$("#secondPage").offset().top-30},1e3),e=!0,$("#pasteSelected").text(t),$(".fixed-container").fadeIn(),!1):($(".ui-select").addClass("ui-select--error"),!1)}),$("#ctaFromSecond").on("submit",function(e){var n=$("#ctaFromSecond"),i=n.find("input[type=text]").val(),o=n.find("input[type=tel]").val(),r=n.find("input[type=email]").val(),s=n.find("input[type=checkbox]:checked").val(),a=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,l=!1,c=!0;if(a.test(r)?(l=!0,c=!1):(l=!1,c=!0),"yes"!=s?(console.log("not agreed"),n.find("input[type=checkbox]").parent().addClass("ui-radio--error")):n.find("input[type=checkbox]").parent().removeClass("ui-radio--error"),c?n.find("input[type=email]").parent().addClass("ui-input--error"):n.find("input[type=email]").parent().removeClass("ui-input--error"),""==i||i.length<=3?n.find("input[type=text]").parent().addClass("ui-input--error"):n.find("input[type=text]").parent().removeClass("ui-input--error"),""==o||o.length<=10?n.find("input[type=tel]").parent().addClass("ui-input--error"):n.find("input[type=tel]").parent().removeClass("ui-input--error"),""==s||c||""==i||i.length<=3||""==o||o.length<=10)return!1;var d={name:i,email:r,phone:o,select:t};$.ajax({type:"POST",url:"php/contact.php",data:d,dataType:"json",encode:!0}).done(function(e){alert(e),e.success&&(n.find(".form__title").fadeOut(),n.find(".form__wrapper").fadeOut(),n.find(".form__thanks__heading span").text(d.name),n.find(".form__thanks").fadeIn())}).fail(function(e){n.find(".form__title").fadeOut(),n.find(".form__wrapper").fadeOut(),n.find(".form__thanks__heading span").text(d.name),n.find(".form__thanks").fadeIn(),console.log(e)}),e.preventDefault()}),$(".ui-select").on("click",function(e){$(this).toggleClass("active")}),$(".ui-select__drop span").on("click",function(e){var n=$(this).data("select");$(this).closest(".ui-select").find("label").text(n),$(this).closest(".ui-select").find("label").addClass("selected"),$(".ui-select").removeClass("ui-select--error"),t=n}),$(document).mouseup(function(e){var t=new Array;t.push($(".ui-select")),$.each(t,function(t,n){$(n).is(e.target)||0!==$(n).has(e.target).length||$(n).removeClass("active")})}),$(".ui-input label").on("click",function(){$(this).parent().find("input").trigger("focus")}),$(".ui-input input").each(function(){$(this).on("focus",function(){$(this).parent(".ui-input").addClass("active")}),$(this).on("blur",function(){0==$(this).val().length&&$(this).parent(".ui-input").removeClass("active")}),""!=$(this).val()&&$(this).parent(".ui-input").addClass("active")}),$(window).resize(function(){e&&($(window).width()<900||$(".fixed-container").show())}),$(window).scrolled(100,function(){var t=$(this).scrollTop();e&&(t>350?$(".fixed-btn").addClass("visible"):$(".fixed-btn").removeClass("visible"))})});